class Transaction:
    ...
    def __init__(self, amount, transaction_ID, transaction_type, description):
    ...
    # TODO: rework process transaction for composition, through account.
    ...
    transaction_ID = property(get_transaction_ID)
